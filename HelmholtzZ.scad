...
// HelmholtzZ.scad — Z axis Helmholtz pair. Target: calibrator.ini [coils] resistance_z_ohms = 13.2 Ω (both coils in series).
// AWG 23 enameled copper; coilNumberOfTurns chosen so combined R matches ~13.2 Ω at coilRadius 105 mm.
// X/Y: HelmholtzX.scad, HelmholtzY.scad
...
coilNumberOfTurns				= 46;		// Per coil; pair ≈ 13.2 Ω combined @ 20°C copper table
...
coilTargetResistanceIni			= 13.2;		// calibrator.ini [coils] resistance_z_ohms (both coils series)
...
module helmholtzStats()
{
	...
	echo( str( "    Axis: Z   Target R (ini): ", coilTargetResistanceIni, " Ohms (pair, series)") );
